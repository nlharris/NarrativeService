...
public class ListObjectsWithSetsParams {
    ...
    public ListObjectsWithSetsParams withWsName(String wsName) {
        this.wsName = wsName;
        return this;
    }
    ...
    public String toString() {
        return ((((((("ListObjectsWithSetsParams"+" [wsName=")+ wsName)+", wsId=")+ wsId)+", additionalProperties=")+ additionalProperties)+"]");
    }
